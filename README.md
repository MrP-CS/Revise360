...
## Data protection: please check before using with students

- The site stores each student's name, class and scores. Check with your school's data protection lead that this is acceptable, and use a school Google account if you have one.
